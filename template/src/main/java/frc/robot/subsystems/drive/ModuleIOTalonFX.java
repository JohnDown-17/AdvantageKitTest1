  ...
  public ModuleIOTalonFX(int index) {
    switch (index) {
      case 0:
        ...
        absoluteEncoderOffset = new Rotation2d(198.87); // MUST BE CALIBRATED
        break;
      case 1:
        driveTalon = new TalonFX(22);
        turnTalon = new TalonFX(12);
        cancoder = new CANcoder(2);
        absoluteEncoderOffset = new Rotation2d(129.55); // MUST BE CALIBRATED
        break;
      case 2:
        driveTalon = new TalonFX(23);
        turnTalon = new TalonFX(13);
        cancoder = new CANcoder(3);
        absoluteEncoderOffset = new Rotation2d(150.56); // MUST BE CALIBRATED
        break;
      case 3:
        driveTalon = new TalonFX(24);
        turnTalon = new TalonFX(14);
        cancoder = new CANcoder(4);
        absoluteEncoderOffset = new Rotation2d(249.87); // MUST BE CALIBRATED
